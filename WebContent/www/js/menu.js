...
var Menu = function() {
	...
	this.getButtonDefault = function(valDefault) {
		...
		jsonEnableButtons["stepstep"] = valDefault;
		jsonEnableButtons["facing"] = true;
		jsonEnableButtons["alertas"] = true;
	...
	this.addBoton_flejes = function(activo, rol, cliente, enabled, key, idMod) {
		...
		if(activo == true) {
			htm += " 	<a href='ingresaliq_"+rol+"_"+cliente+"/procesos/planilla_por_sala.html' data-transition='flip' > ";
		}
		else {
			htm += " 	<a href='javascript:;' onclick='var popup = new MasterPopup(); popup.alertPopup(\"Anywhere\",\"M&#243;dulo desactivado\"); ' > ";		
		}
		
		htm += " 		<img width='96'src='images/btns/037-cloud-computing.png'> ";
		htm += " 			<h2>Ingreso de liquidaci&oacute;n</h2><p>Ingresa la liquidaci&oacute;n de sueldo de tu nana aqu&iacute;</p> "; 
		htm += " 	</a>"; 
		htm += " </li>";
	...
	this.addBoton_alertas = function(activo, rol, cliente, enabled, idMod) {
		...
		if(activo == true) {
			htm += " 	<a href='fichanana_"+rol+"_"+cliente+"/procesos/planilla_por_sala.html' data-transition='flip' > ";
		}
		else {
			htm += " 	<a href='javascript:;' onclick='var popup = new MasterPopup(); popup.alertPopup(\"Anywhere\",\"M&#243;dulo desactivado\"); ' > ";		
		}
		
		htm += " 		<img width='96'src='images/btns/022-picture.png'> ";
		htm += " 			<h2>Ficha personal</h2><p>Aqu&iacute; puedes ver tus todos tus datos</p> "; 
		htm += " 	</a>"; 
		htm += " </li>";
	...
	this.addBoton_quiebres = function(activo, rol, cliente, enabled, idMod) {
		...
		if(activo == true) {
			htm += " 	<a href='documentos_"+rol+"_"+cliente+"/procesos/planilla_por_sala.html' data-transition='flip' > ";
		}
		else {
			htm += " 	<a href='javascript:;' onclick='var popup = new MasterPopup(); popup.alertPopup(\"Anywhere\",\"M&#243;dulo desactivado\"); ' > ";		
		}
		
		htm += " 		<img width='96'src='images/btns/021-file.png'> ";
		htm += " 			<h2>Documentos</h2><p>Obt&eacute;n tus liquidaciones de sueldo y certificados</p> "; 
		htm += " 	</a>"; 
		htm += " </li>";
	...
	this.addBoton_preciosyfacing = function(activo, rol, cliente, enabled, idMod) {
		...
		if(activo == true) {
			htm += " 	<a href='ingresanana_"+rol+"_"+cliente+"/procesos/planilla_por_sala.html' data-transition='flip' > ";
		}
		else {
			htm += " 	<a href='javascript:;' onclick='var popup = new MasterPopup(); popup.alertPopup(\"Anywhere\",\"M&#243;dulo desactivado\"); ' > ";		
		}
		
		htm += " 		<img width='96'src='images/btns/011-add-user.png'> ";
		htm += " 			<h2>Datos de tu nana</h2><p>Registra o actualiza los datos de tu nana</p> "; 
		htm += " 	</a>"; 
		htm += " </li>";
